...
late _dashboardState stateofDashboard;
...
class _dashboardState extends State<dashboard> {
  ...
  getSubmission() async{
    http.Response response = await http.post(Uri.parse(getSubmissionByParentId),
      headers: <String,String>{
        'Content-Type': 'application/json; charset=UTF-8'
      },
      body: jsonEncode(<String, String>{
    ...
    stateofHomeScreen.setState(() {
      stateofHomeScreen.heads = Row(
        ...
        children: [
          oneCard(icon: Icon(Iconsax.grammerly,size: 50.0,),
              title: "${stateofHomeScreen.widget.childData.keys.length.toString()}", sub: "Childrens"),
                    ...
                    Row(
                      children: [
                        ...
                        TextButton(onPressed: (){
                          navScreen(Allodart(bodies: classes(data: stateofHomeScreen.widget.data)), context, false);
                        }, child: onlymainText("View All", secColor, 10.0, FontWeight.normal,1))
                      ],
                    ),
