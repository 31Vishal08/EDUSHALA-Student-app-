              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        mainTextFAQS("Welcome back!", textColor, 20.0, FontWeight.w700, 2),
                        Spacer(),
                      ],
                    ),

                    SizedBox(height: 50.0,),
                    Image.asset("Assets/login.png",width: MediaQuery.of(context).size.width * 0.80,),

                    SizedBox(height: 40.0,),
                    Row(
                      children: [
                        Spacer(),
                        onlymainText("Login Now", mainColor, 19.0, FontWeight.normal, 2),
                        Spacer(),
                      ],
                    ),
                    SizedBox(height: 5.0,),
                    Row(
                      children: [
                        Spacer(),
                        mainText("To proceed, please provide your mobile number\n"
                            "You’ll receive 6 digit code to verify next",textLight, 6.0, FontWeight.normal, 2),
                        Spacer(),
                      ],
                    ),
                            ...
                            Column(
                              ...
                              children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: InternationalPhoneNumberInput(
                                      onInputChanged: (PhoneNumber n){
                                        ...
                                        btnChanger(n.phoneNumber.toString().length - n.dialCode.toString().length);
                                      },
                                      textStyle: TextStyle(
                                        fontFamily: 'mons',
                                        fontSize: 15.0,
                                ...
                                Container(
                                  ...
                                  height: 50.0,
                                  margin: EdgeInsets.fromLTRB(10, 40.0, 10.0,0.0),
                                  child: custombtnsss("Continue", () {LoginwithMobile(); }, secColor, bgColor,30.0),),
                                Row(
                                  children: [
                                    Spacer(),
                                    onlymainText("Don't have an account", textLight, 12.0, FontWeight.normal, 1),
                                    TextButton(onPressed: (){
                                      navScreen(registerNow(), context, false);
                                    }, child: onlymainText("Register", mainColor, 12.0, FontWeight.bold, 1),),
                                    Spacer(),
                                  ],
                                ),
